...
public class FiltrUsuAdapter extends RecyclerView.Adapter<FiltrUsuAdapter.ViewHolder> {
    ...
    private int idUser;
    public FiltrUsuAdapter(Context mContext, ArrayList<Restaurante> lstRestaurantes, ArrayList<Plato> carroCompras, String tvCantProductos, int idUser){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.bt1n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                miIntent.putExtra("idUser",idUser);
