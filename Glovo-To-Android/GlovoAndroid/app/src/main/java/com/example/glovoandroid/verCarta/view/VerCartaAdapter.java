...
public class VerCartaAdapter extends RecyclerView.Adapter<VerCartaAdapter.ViewHolder> {
    ...
    private int idUser;
    public VerCartaAdapter(Context mContext, ArrayList<Plato> lstPlato, TextView tvCantProductos, Button verCarro, ImageView btnVolver, ArrayList<Plato> carroCompra, int idRestaurante,int idUser){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        verCarro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("tvCantProductos", tvCantProductos.getText().toString());
