...
public class VerFichaAdapter extends RecyclerView.Adapter<VerFichaAdapter.ViewHolder> {
    ...
    public VerFichaAdapter(Context mContext, ArrayList<Restaurante> lstRestaurantes){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_ver_ficha,parent,false);
