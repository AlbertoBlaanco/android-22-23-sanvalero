...
public class VerFichaAdapter extends RecyclerView.Adapter<VerFichaAdapter.ViewHolder> {
    ...
    public VerFichaAdapter(Context mContext, ArrayList<Restaurante> lstRestaurantes, ImageView btnvolver, ArrayList<Plato> carroCompra,Button btnVerCarro,TextView tvCantProductos,int idRestaurante,int idUser){
